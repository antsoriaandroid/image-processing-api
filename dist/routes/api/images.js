...
images.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var isValid, filename, height, width;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                isValid = imageUtilities_1.default.areParametersValid(req);
            ...
            case 1:
                ...
                if (!!imageUtilities_1.default.existsImage(filename)) return [3 /*break*/, 2];
                res.status(400).send("Image doesn't exists");
                return [3 /*break*/, 5];
            case 2:
                if (!!imageUtilities_1.default.existsThumbnail(filename, width, height)) return [3 /*break*/, 4];
                return [4 /*yield*/, imageUtilities_1.default.resizeImage(filename, width, height)];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
                ...
                res.status(200);*/
                res.sendFile(path_1.default.resolve("./images/thumbnails/" +
                    filename +
                    "-h" +
                    height +
                    "-w" +
